...
namespace Polyfill.Threading.Tasks
{
    ...
    public static class Parallel
    {
        ...
        static int GetEffectiveMaxConcurrencyLevel(ParallelOptions parallelOptions)
        {
            ...
            int schedulerMax = GetEffectiveTaskScheduler(parallelOptions).MaximumConcurrencyLevel;
        ...
        /// <returns>A task that represents the entire for each operation.</returns>
        /// <remarks>The operation will execute at most <see cref="Environment.ProcessorCount"/> operations in parallel.</remarks>
        public static Task ForEachAsync<TSource>(IEnumerable<TSource> source, Func<TSource, CancellationToken, ValueTask> body, CancellationToken cancellationToken)
        {
            if (source is null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        public static Task ForEachAsync<TSource>(IEnumerable<TSource> source, ParallelOptions parallelOptions, Func<TSource, CancellationToken, ValueTask> body)
        {
            ...
            return ForEachAsync(source, GetEffectiveMaxConcurrencyLevel(parallelOptions), GetEffectiveTaskScheduler(parallelOptions), parallelOptions.CancellationToken, body);
        }
        ...
        private abstract class ForEachAsyncState<TSource> : TaskCompletionSource<bool>, IThreadPoolWorkItem
        {
            ...
            public void QueueWorkerIfDopAvailable()
            {
                if (_remainingDop > 0)
                {
                    ...
                    else
                    {
                        ...
                        factory.StartNew(_taskBody!, this, default, TaskCreationOptions.DenyChildAttach, _scheduler);
                    }
                }
            }
            ...
            void IThreadPoolWorkItem.Execute()
            {
                ...
                {
                    ExecutionContext.Run(_executionContext, o => ((ForEachAsyncState<TSource>)o!)._taskBody(o), this);
                }
            }
        }
        ...
        private sealed class SyncForEachAsyncState<TSource> : ForEachAsyncState<TSource>, IDisposable
        {
            ...
            {
                Enumerator = source.GetEnumerator() ?? throw new InvalidOperationException("The source returned a null enumerator.");
            }
        ...
        private sealed class AsyncForEachAsyncState<TSource> : ForEachAsyncState<TSource>, IAsyncDisposable
        {
            ...
            public AsyncForEachAsyncState(
                ...
                base(taskBody, dop, scheduler, cancellationToken, body)
            {
                Enumerator = source.GetAsyncEnumerator(Cancellation.Token) ?? throw new InvalidOperationException("The source returned a null enumerator.");
            }
